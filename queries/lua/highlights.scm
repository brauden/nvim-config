; Override for nvim-treesitter main branch Lua highlights.
; Fixes "operator" -> "operand" field name for Neovim 0.11.6 compatibility.
; TODO: Remove this file once nvim-treesitter fixes upstream queries.
...
; Operators (fixed: field "operator" doesn't exist in this parser version)
[
  "+"
  "-"
  "*"
